...
, thisDTC_		(0)
{
  ...
  __MCOUT_INFO__("ROCStoppingTargetMonitorInterface instantiated with link: " << linkID_
...
//==================================================================================================
void ROCStoppingTargetMonitorInterface::writeRegister(unsigned address, unsigned data_to_write)
{
	if(emulatorMode_)
	{
...
//==================================================================================================
int ROCStoppingTargetMonitorInterface::readRegister(unsigned address)
{
...
void ROCStoppingTargetMonitorInterface::highRateCheck(void)
{
	...
	std::thread([](ROCStoppingTargetMonitorInterface *roc)
	{ 		
...
//==================================================================================================
void ROCStoppingTargetMonitorInterface::highRateCheckThread(ROCStoppingTargetMonitorInterface *roc)
try
{
